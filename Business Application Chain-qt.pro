TEMPLATE = app
TARGET = BusinessApplicationChainCoin-qt
VERSION = 0.8.5
...
QT += testlib
TARGET = BusinessApplicationChainCoin-qt_test
...
macx:ICON = src/qt/res/icons/BusinessApplicationChainCoin.icns
macx:TARGET = "BusinessApplicationChainCoin-Qt"
